...
<head>
	...
	<title>Order Details - Itemstore Administration</title>
	...
	<div align="center">
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					<img style="vertical-align: middle;" src="data:image/jpg;base64,${orderDetail.item.base64Image}" width="48" height="64" />
					${orderDetail.item.name}
				</td>
				<td>${orderDetail.item.seller}</td>
				<td><fmt:formatNumber value="${orderDetail.item.price}" type="currency" /></td>
