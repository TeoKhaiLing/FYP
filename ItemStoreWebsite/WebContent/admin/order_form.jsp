...
<head>
	...
	<title>Edit Order - Itemstore Administration</title>
...
<body>
	...
	<div align="center">
		...
		<table border="1">
			...
			<tr>
				...
				<td>${orderDetail.item.seller}</td>
				<td>
					<input type="hidden" name="price" value="${orderDetail.item.price}" />
					<fmt:formatNumber value="${orderDetail.item.price}" type="currency" />
				</td>
				<td>
					<input type="hidden" name="itemId" value="${orderDetail.item.itemId}" />
					<input type="text" name="quantity${status.index + 1}" value="${orderDetail.quantity}" size="5" />
				</td>
				
				<td><fmt:formatNumber value="${orderDetail.subtotal}" type="currency" /></td>
				<td><a href="remove_item_from_order?id=${orderDetail.item.itemId}">Remove</a></td>
			</tr>
			</c:forEach>
			<tr>
	...
	<div align="center">
		<br/>		
		<a href="javascript:showAddItemPopup()"><b>Add Items</b></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		function showAddItemPopup() {
			...
			window.open('add_item_form', '_blank', 
